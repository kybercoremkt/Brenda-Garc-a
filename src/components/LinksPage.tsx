...
export default function LinksPage({ onBackToHome }: LinksPageProps) {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      subtitle: 'Historias, tips rápidos y mi día a día 📸',
      url: 'https://www.instagram.com/brenda.garciamx',
      bgClass: 'bg-white hover:bg-pink-50/10 border-slate-200 hover:border-pink-200 text-slate-800 hover:text-pink-600',
      iconClass: 'bg-gradient-to-tr from-yellow-500 via-pink-500 to-purple-600 text-white',
      icon: (
        <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
